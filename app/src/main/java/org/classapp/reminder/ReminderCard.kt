...
@Composable
fun ReminderCard(reminder: ReminderResponse, modifier: Modifier, onDelete: (ReminderResponse) -> Unit) {

    val reminderService = ReminderRepo()
    ...
    Surface(
        ...
        Box() {
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Text(reminder.dateTime.toString(), style = MaterialTheme.typography.body2)
            }
            Column(
